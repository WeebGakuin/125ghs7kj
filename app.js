...
<div class="mdui-container">
  ...
  <div class="mdui-center mdui-text-center mdui-text-color-blue-grey-5001" style="margin-bottom: 20px"><a href='https://ko-fi.com/X8X86DYCY' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://cdn.ko-fi.com/cdn/kofi5.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a><br>Donations are required to cover the server expenses<br>${UI.footer_text}</div>
  `;
    if (UI.credits) {
        html += `
...
function append_files_to_list(path, files) {
    ...
    for (i in files) {
        ...
        if ((short_name.includes("B-Global")||short_name.includes("HIDIVE"))&&(smatches != null)) {
